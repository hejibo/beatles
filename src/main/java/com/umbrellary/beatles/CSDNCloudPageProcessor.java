...
public class CSDNCloudPageProcessor implements PageProcessor {

    // \\d+匹配页码数字
    public static final String URL_LIST = "/cloud/\\d+";

    // \\d+匹配页码数字 \\w+匹配任意字符串
    public static final String URL_POST = "http://www\\.csdn\\.net/article/\\d+-\\d+-\\d+/\\w+";

    private Site site = Site.me().setDomain("cloud.csdn.net").setSleepTime(3000).setUserAgent("Mozilla/5.0 (Macintosh; Intel Mac OS X 10_7_2) AppleWebKit/537.31 (KHTML, like Gecko) Chrome/26.0.1410.65 Safari/537.31");
